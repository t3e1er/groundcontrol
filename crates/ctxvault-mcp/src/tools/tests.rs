...
fn test_fast_mode_mcp_tools() {
    ...
    let hyb_res = registry
        ...
        .unwrap();
    let hyb_resp: ctxvault_common::types::SearchResponse = serde_json::from_value(hyb_res).unwrap();
...
"#;
    ...
    let ids_res = registry
        ...
        .unwrap();
    let ids_resp: ctxvault_common::types::SearchResponse = serde_json::from_value(ids_res).unwrap();
...
"#;
    ...
    let resp: ctxvault_common::types::SearchResponse = serde_json::from_value(search_val).unwrap();
...
"#;
    ...
    let json_val = registry
        ...
        .unwrap();
    let resp: ctxvault_common::types::SearchResponse = serde_json::from_value(json_val).unwrap();
