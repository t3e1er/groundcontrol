...
fn test_find_symbols_by_normalized_scope() {
    ...
    let sym1 = groundcontrol_common::types::CodeSymbol {
    ...
    let sym4 = groundcontrol_common::types::CodeSymbol {
...
fn test_external_refs_round_trip_and_idempotent() {
    use groundcontrol_common::types::{ExternalRef, ExternalRefKind, ResolutionConfidence};
