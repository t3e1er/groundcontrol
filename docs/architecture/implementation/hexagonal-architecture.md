...
* **Port Trait Definitions**: [`crates/groundcontrol-common/src/ports.rs`](file:///c:/dev/ctx/groundcontrol/crates/groundcontrol-common/src/ports.rs)
* **Composition Root**: [`crates/groundcontrol-cli/src/main.rs`](file:///c:/dev/ctx/groundcontrol/crates/groundcontrol-cli/src/main.rs)
* **Engine Orchestrator**: [`crates/groundcontrol-core/src/engine.rs`](file:///c:/dev/ctx/groundcontrol/crates/groundcontrol-core/src/engine.rs)
...
* `tantivy::Index` is strictly internal to `groundcontrol-core::index::TantivyTextIndex`.
...
### Composition Root
[`crates/groundcontrol-cli/src/main.rs`](file:///c:/dev/ctx/groundcontrol/crates/groundcontrol-cli/src/main.rs) is the **only composition root** in the entire codebase. It instantiates the concrete adapters, wires them into `EngineBuilder`, and passes the constructed `Engine` or `CorpusManager` to the MCP transport.
